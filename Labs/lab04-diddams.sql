...
where custid =
	(select top(1) with ties o.custid from sales.orders o
	group by o.custid
...
--NOT IN may return Unknown, while NOT EXIST will return TRUE if the NOT predicate is true
...
select custid, orderdate, orderid, 
	(select top(1) o2.orderdate from sales.orders o2
	where o2.custid = o1.custid
