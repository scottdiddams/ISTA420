...
--to get orders in jan OR feb - replace INTERSECT with UNION
--to get orders in jan but NOT feb - use except
...
(SELECT 1 as S, country, region, city
FROM HR.Employees
...
order by S, country, region, city;
...
select city, country from hr.employees
intersect
select city, country from sales.customers;

--5. cities and countries where we have customers OR employees

select city, country from hr.employees
union
select city, country from sales.customers;

--6. Customers but not employees

select city, country from sales.customers
except
select city, country from hr.employees;

--7. employees but not customers

select city, country from hr.employees
except
select city, country from sales.customers;

--8. employees but not customers AND customers but not employees
